...
You can [integrate Yjs into your existing communication infrastructure](/tutorials/creating-a-custom-provider.md) or use one of the [several existing network providers](/ecosystem/connection-provider.md) that allow you to jump-start your application backend.
